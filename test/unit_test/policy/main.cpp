...
TEST_F(PolicyTest, RuleManagerConfig)
{
    ...
    EXPECT_EQ(air::ProcessorType::PERFORMANCE,
        node[cfg::GetSentenceIndex(config::ParagraphType::NODE, "PERF_PSD")].processor_type);
    EXPECT_EQ(air::ProcessorType::LATENCY,
        node[cfg::GetSentenceIndex(config::ParagraphType::NODE, "LAT_PSD")].processor_type);
    EXPECT_EQ(air::ProcessorType::QUEUE,
        node[cfg::GetSentenceIndex(config::ParagraphType::NODE, "Q_EVENT")].processor_type);
